...
public class PickaxeItemInject extends DiggerItem {
    ...
    public boolean canPerformAction(ItemStack stack, ToolAction toolAction) {
        return io.github.fabricators_of_create.porting_lib.util.ToolActions.DEFAULT_PICKAXE_ACTIONS.contains(toolAction);
    }
