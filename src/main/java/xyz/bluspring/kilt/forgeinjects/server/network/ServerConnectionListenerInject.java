...
public class ServerConnectionListenerInject {
    @ModifyReceiver(method = "method_14348", at = @At(value = "INVOKE", target = "Lcom/google/common/util/concurrent/ThreadFactoryBuilder;setDaemon(Z)Lcom/google/common/util/concurrent/ThreadFactoryBuilder;"))
    ...
    @ModifyReceiver(method = "method_14349", at = @At(value = "INVOKE", target = "Lcom/google/common/util/concurrent/ThreadFactoryBuilder;setDaemon(Z)Lcom/google/common/util/concurrent/ThreadFactoryBuilder;"))
