...
public abstract class ServerAdvancementManagerInject implements ServerAdvancementManagerInjection {
    ...
    private Advancement.Builder kilt$createBuilderWithContext(JsonObject json, DeserializationContext context, @Cancellable CallbackInfo ci, @Local(argsOnly = true) ResourceLocation location) {
