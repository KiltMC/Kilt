package xyz.bluspring.kilt.injects.world.entity.animal.parrot;
...
public abstract class ParrotInject extends ShoulderRidingEntity {
    ...
    @Definition(id = "random", field = "Lnet/minecraft/world/entity/animal/parrot/Parrot;random:Lnet/minecraft/util/RandomSource;")
