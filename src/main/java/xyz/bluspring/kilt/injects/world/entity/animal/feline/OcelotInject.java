package xyz.bluspring.kilt.injects.world.entity.animal.feline;
...
public abstract class OcelotInject extends Animal {
    ...
    @Definition(id = "random", field = "Lnet/minecraft/world/entity/animal/feline/Ocelot;random:Lnet/minecraft/util/RandomSource;")
