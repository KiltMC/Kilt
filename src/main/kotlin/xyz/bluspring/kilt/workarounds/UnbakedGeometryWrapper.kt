...
class UnbakedGeometryWrapper<T : FabricUnbakedGeometry<T>>(private val deferred: FabricUnbakedGeometry<T>) : IUnbakedGeometry<T> {
    override fun bake(
        ...
        return deferred.bake(ForgeGeometryBakingContextWrapper(context), bakery, spriteGetter, modelState, overrides, modelLocation)
    }
    ...
    override fun getMaterials(
        ...
        return deferred.getMaterials(ForgeGeometryBakingContextWrapper(context), modelGetter, missingTextureErrors)
    }
}