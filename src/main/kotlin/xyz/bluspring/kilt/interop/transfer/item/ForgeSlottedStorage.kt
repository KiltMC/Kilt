...
class ForgeSlottedStorage(val handler: IItemHandler) : SlotExposedStorage {
    ...
    fun getSlot(slot: Int): SingleSlotStorage<ItemVariant> {
    ...
    override fun isItemValid(
        ...
        return handler.isItemValid(slot, item.toStack(amount.toInt()))
    }
