...
object OverridingMethodWrappers {
    ...
    init {
        ...
        val unmappedFinalizedSpawnDesc = "(Lnet/minecraft/world/level/ServerLevelAccessor;Lnet/minecraft/world/DifficultyInstance;Lnet/minecraft/world/entity/MobSpawnType;Lnet/minecraft/world/entity/SpawnGroupData;Lnet/minecraft/nbt/CompoundTag;)Lnet/minecraft/world/entity/SpawnGroupData;"
        val finalizeSpawnName = KiltRemapper.enhancedMojangRemapper?.mapMethodName("net/minecraft/world/entity/Mob", "finalizeSpawn", unmappedFinalizedSpawnDesc)
    ...
    private fun prepareMixinFromTemplate(
        ...
        classNode.name = "${mixinPackage.replace(".", "/")}/$name"
        ...
        fun remapAnnotation(annotationNode: AnnotationNode) {
            MixinRemapper.remapMixinAnnotation(
                annotationNode, KiltRemapper.enhancedMojangRemapper!!,
