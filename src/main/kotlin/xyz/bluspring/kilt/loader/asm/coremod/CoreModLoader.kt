...
object CoreModLoader {
    ...
    fun loadJavaCoreMods() {
        ...
        val coremods = ServiceLoader.load(ClassProcessorProvider::class.java)
        val mergedTransformers = mutableMapOf<String, MutableList<ClassProcessor>>()
        val context = ClassProcessorProvider.Context()

        // FIXME: Coremods have been refactored, drastically.
//
