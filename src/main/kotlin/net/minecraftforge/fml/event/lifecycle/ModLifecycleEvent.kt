...
open class ModLifecycleEvent(val container: ModContainer?) : Event(), IModBusEvent {
    ...
    val IMCStream: Stream<InterModComms.IMCMessage>
        get() = InterModComms.getMessages(container!!.modId)

    fun getIMCStream(methodFilter: Predicate<String>): Stream<InterModComms.IMCMessage> {
        return InterModComms.getMessages(container!!.modId, methodFilter)
    }
